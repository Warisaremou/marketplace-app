      ...
      <div>
              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                  ...
                  <form className="mt-4 border-t border-gray-200">
                    ...
                    <ul role="list" className="px-2 py-3 font-medium text-gray-600">
        ...
        <main className="mx-auto max-w-full">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6">
            <h1 className="text-xs md:text-xl font-bold tracking-tight text-gray-600">
              Catégories
            </h1>
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <Menu.Button className="group inline-flex justify-center text-xs md:text-sm font-medium text-gray-700 hover:text-gray-600">
                    Filtrer par
                    <ChevronDownIcon
